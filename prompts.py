...
- Sa pertinence par rapport au projet (expériences similaires).
...
Assure-toi que le texte respecte les normes de rédaction des mémoires techniques dans le secteur du BTP, tout en restant clair, précis et pertinent vis-à-vis de l’appel d’offre.""",
    "expertise": """Rédige la section « Expertise » du mémoire technique de la société {nom_entreprise}. Cette section doit s’inscrire dans la continuité de la partie « Historique » mais sans répéter les informations déjà mentionnées dans cette dernière. L'objectif est de mettre en avant les compétences, les domaines de spécialisation, les méthodes et l’expérience spécifique de l’entreprise. Focus sur les critères techniques dominants : si la note technique valorise la méthode d’exécution, la logistique, ou l’innovation, insiste particulièrement sur ces points.
...
Veille à ce que ce paragraphe, d'une longueur de 10 à 15 lignes, réponde précisément aux attentes du règlement de consultation, tout en évitant les répétitions avec la section « Historique ».""",
    "vision_et_valeurs": """Rédige la partie « Vision et Valeurs » du mémoire technique de la société {nom_entreprise}. Ce mémoire technique doit répondre au dossier de consultation suivant : dossier-consultation.pdf . Reformule les éléments présents dans memoire-technique.pdf, fait si possible des liens directs avec les sous-critères (p. ex. démarche RSE si valorisée).
Exemple :
...
Ce paragraphe fera entre 5 et 10 lignes.""",
    ...
    "competences_techniques_specifiques": """Rédige la partie « Compétences Techniques Spécifiques » du mémoire technique de la société {nom_entreprise}. Zoom sur les domaines d’excellence de l’entreprise. Montre en quoi ces compétences répondent aux exigences clés du projet. Tu utiliseras les infos pertinentes récupérées à partir du fichier 'memoire-technique.pdf' pour répondre parfaitement au règlement de consultation suivant : dossier-consultation.pdf""",
    "moyens_humains": """Résume les noms, prénoms, postes, rôles et informations concernant tous les membres de l'équipe mentionnés dans le fichier 'memoire-technique.pdf'. Montre l’adéquation entre l’équipe et les exigences du dossier de consultation. Puis, propose un organigramme clair et structuré, illustrant la répartition des équipes et la hiérarchie au sein de l’organisation.""",
...
"{requis_dossier_consultation}". Mettre en avant l'importance de la maintenance, de la disponibilité, etc., si valorisées par le dossier de consultation.
...
Pour cela, tu citeras la totalité des processus internes et certifications obtenues à partir du fichier 'memoire-technique.pdf' pour répondre parfaitement au règlement de consultation. Exemples : ISO 9001, ISO 14001, MASE, ...
...
Pour cela, tu citeras la totalité des normes de sécurité à mettre en place pour répondre parfaitement au règlement de consultation. Si besoin, tu évoqueras la Politique de sécurité et le plan HSE.""",
    "respect_environnement": """Rédige la partie « Respect de l'Environnement » du mémoire technique de la société {nom_entreprise}.
Pour cela, tu citeras la totalité des normes et bonnes pratiques à mettre en place sur un chantier pour répondre parfaitement au règlement de consultation. Tu affirmeras notamment l'engagement environnemental de la société (gestion des déchets, réduction des nuisances, etc.).
""",
    "references_et_realisations_passees": """Rédige la partie « Références et Réalisations Passées » du mémoire technique.
Pour cela, tu choisiras les références les plus pertinentes par rapport aux critères du dossier de consultation. S’il y a une pondération forte sur l’expérience similaire, illustrer avec détails : type de travaux, budget, respect des délais, retours client. Adapte les références et réalisations passées de la société {nom_entreprise} obtenues à partir du fichier 'memoire-technique.pdf' pour répondre parfaitement au règlement de consultation.""",
...
Pour cela, tu citeras la totalité des témoignages reçus par la société {nom_entreprise} obtenus à partir du fichier 'memoire-technique.pdf'. Tu présenteras les témoignages sous la forme de liste, avec le maximum d'informations à chaque fois : nom, prénom, société, chantier réalisé, témoignage... pour répondre parfaitement au règlement de consultation.""",
    "methode_gestion_projet": """Rédige la partie « Approche de Gestion de Projet » du mémoire technique de la société {nom_entreprise}. Pour cela, tu rédigeras une méthodologie de gestion de projet idéale. Démontrer la rigueur de l’organisation (phases, jalons, livrables). Prouver la maîtrise de la méthode (reporting, communication, outils de suivi).
Tu utiliseras les infos pertinentes récupérées à partir du fichier 'memoire-technique.pdf' pour répondre parfaitement au règlement de consultation.
Pour rappel, Informations :
"{infos_dossier_consultation}"
et requis :
